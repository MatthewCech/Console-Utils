...
namespace RConsole
{
  ...
  bool Console::DrawPartialPoint(float x, float y, ColorData color)
  {
  ...
  bool Console::DrawAlphaPoint(float x, float y, ColorData color, float opacity)
  {
  ...
  bool Console::DrawChar(char toDraw, float x, float y, ColorData color)
  {
    //Truncate floats
  ...
  //Set the color
  void Console::SetColor(ColorData color)
  {
  ...
  unsigned int Console::GetConsoleHeight() { return rlutil::trows(); }
}
